      ...
      child: SafeArea(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                icon: SvgPicture.asset("assets/icons/plus_post.svg",
                  color: MenuState.add_post == selectedMenu
                      ? kPrimaryColor
                      : inActiveIconColor,),
                onPressed: () =>
                    Navigator.pushNamed(context, PostPictureScreen.routeName),
              ),
              IconButton(
                icon: SvgPicture.asset(
